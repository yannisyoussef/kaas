...
This document describes repository reality after the continuous execution authority slice (ADR-029). Product vision and execution architecture do not imply runtime capability: the repository executes a platform-owned synthetic workload and no tenant content.
