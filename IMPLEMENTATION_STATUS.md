...
This document describes repository reality after the hostile-content readiness adjudication (KAAS-17). Product vision and execution architecture do not imply runtime capability: the repository executes a platform-owned synthetic workload and no tenant content.
